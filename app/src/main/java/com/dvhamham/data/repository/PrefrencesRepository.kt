...
class PreferencesRepository(private val context: Context) {
    ...
    private object PreferenceKeys {
        ...
        val HOOK_SYSTEM_LOCATION = booleanPreferencesKey("hook_system_location")
    }
    ...
    fun getHookSystemLocationFlow(): Flow<Boolean> {
        return getPreferenceFlow(PreferenceKeys.HOOK_SYSTEM_LOCATION, false)
    }
    
    suspend fun saveHookSystemLocation(hookSystemLocation: Boolean) {
        savePreference(PreferenceKeys.HOOK_SYSTEM_LOCATION, hookSystemLocation, "hook_system_location", hookSystemLocation)
    }
    
    // For backward compatibility
    fun getHookSystemLocation(): Boolean {
        return sharedPrefs.getBoolean("hook_system_location", false)
    }
}