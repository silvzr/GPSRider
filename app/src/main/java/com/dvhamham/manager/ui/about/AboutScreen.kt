...
fun AppDescription() {
    Text(
        text = """
            GPS Rider allows you to mock your location for testing or automation.
            
            Supported features:
            - Start fake location
            - Stop fake location
            - Toggle fake location
            - Get status
            ...
            Use it responsibly and comply with all local regulations. You are fully responsible for the use of this app.
        """.trimIndent(),
...
fun AppDeveloperValue() {
    ...
    Text(
        ...
        modifier = Modifier
            .padding(top = 4.dp)
            .clickable {
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/dvhamham"))
