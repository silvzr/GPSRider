...
class SettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // Preferences for Hook System Location
    private val _hookSystemLocationPreference = BooleanPreference(
        false, // Default to false for safety
        preferencesRepository.getHookSystemLocationFlow(),
        preferencesRepository::saveHookSystemLocation,
        viewModelScope
    )
    val hookSystemLocation: StateFlow<Boolean> = _hookSystemLocationPreference.state
    ...
    fun setHookSystemLocation(value: Boolean) = _hookSystemLocationPreference.setValue(value)
}